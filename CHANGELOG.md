...
- Cursor support with `--classic -n` when opening projects
...
- Workflow keyword and actions updated from VS Code to Cursor
- README rewritten for the Cursor fork
- `package.json` authorship updated to reflect fork maintenance while crediting vivaxy

---

## Upstream changelog (alfred-open-in-vscode)

The following entries are from the original project by vivaxy.

### [1.0.2](https://github.com/vivaxy/alfred-open-in-vscode/compare/v2.0.1...v1.0.2) (2025-08-12)

### [1.0.1](https://github.com/vivaxy/alfred-open-in-vscode/compare/v2.0.1...v1.0.1) (2025-08-12)
